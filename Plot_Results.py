...
def wqplot_Alg_Results():
    ...
    for b in range(len(Terms)):
        ...
        dot_markers = [plt.Line2D([2], [2], marker='s', color='w', markerfacecolor=color, markersize=10) for color
                       in colors]
        plt.legend(dot_markers, Algorithm, loc='upper center', bbox_to_anchor=(0.5, 1.08), fontsize=9,
        ...
        plt.xticks(X + 0.30, ('Image 1', 'Image 2', 'Image 3', 'Image 4', 'Image 5'), fontname="Arial", fontsize=12,
                   fontweight='bold', color='k')
        plt.ylabel(Terms[b], fontname="Arial", fontsize=12, fontweight='bold', color='k')
...
def plot_Bar_Results():
    ...
    for b in range(len(Terms)):
        ...
        dot_markers = [plt.Line2D([2], [2], marker='s', color='w', markerfacecolor=color, markersize=10) for color
                       in colors]
        plt.legend(dot_markers, Classifier, loc='upper center', bbox_to_anchor=(0.5, 1.08), fontsize=9,
